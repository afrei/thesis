...
\textbf{Definition.} We say that a \(\{x_i | i \in I\}\) where \(I\) is an ordered set is a sequence of \textit{order indiscernibles} if, given two increasing sequences of length \(n\) from \(I\), 
