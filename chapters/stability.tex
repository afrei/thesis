...
\subsection{Realizing Uncountably Many Types Over a Countable Set}
...
In our case, subsets of \(\Phi\) color subsets of size \(n\) taken from \(M\) by seeing which formulae of \(\Phi\) are true of the (ordered) elements of the subset. %This could maybe be better. 
...
\subsection{Realizing Only Countably Many Types Over Every Countable Set}

% This section could also use help. 
...
Note that \(\mathcal{H}(I) \prec \mcM\). % it's worth explaining why
