...
We see that construction relied on homogeneity. 
\end{proof}
...
% TODO A: Revise this proof sections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{enumerate}
...
We can also take \((\mcN', \mcM')\) to be countable as we did in Theorem \ref{theorem_countable_vaughtian_pair}. 
...
This is actually a complete type as \(\theta \in p\) exactly when it is true of uncountably many elements of \(\mcM\) and \(\neg \theta \in p\) otherwise.
...
%(specifically, \(\mcM \prec \mcM_0\)). Why is this here?
