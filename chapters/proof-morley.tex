...
The fact that, because of their cardinalities, any equinumerous models will have the same dimension over this prime model. %8-1
...
One of these cases must happen for arbitrarily large \(n\).  % 10-1
...
In this model, \(\{\bar{v}\mid\psi(\bar{w}, \bar{v})\}\) defines an infinite subset, for which \(U(\bar{v})\) holds, in other words, a Vaughtian pair. %10-2
...
This almost gives us that algebraic closure is a pregeometry. %10-3
