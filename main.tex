...
\usepackage{amsfonts,amssymb,amsthm,color, fixltx2e}
...
%
\bibitem[End]{end}Enderton, Herbert B. A Mathematical Introduction to Logic, Second Edition, 2001 
